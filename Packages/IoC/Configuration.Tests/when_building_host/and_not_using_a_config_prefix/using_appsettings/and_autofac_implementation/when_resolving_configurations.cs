...
namespace IoCExtensions.Configuration.when_building_host.and_not_using_a_config_prefix.using_appsettings.and_autofac_implementation;

public class when_resolving_configurations : and_microsoft_implementation.given.the_host
{
	void Because()
	{
		SetupAllServices();
