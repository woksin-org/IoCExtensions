...
public static class HostExtensions
{
    ...
    /// <param name="builder">The <see cref="IHostBuilder"/>.</param>
    /// <param name="assembly">The <see cref="Assembly"/> that will be used to find configuration classes. </param>
    /// <param name="configure">The callback to configure the <see cref="ConfigurationBuilder"/>.</param>
    /// <param name="configurationPrefixes">The configuration prefixes.</param>
    /// <returns>The builder for continuation.</returns>
    public static IHostBuilder UseConfigurationExtension(this IHostBuilder builder, Assembly assembly, Action<ConfigurationBuilder> configure, params string[] configurationPrefixes)
    {
    ...
    /// <param name="configurationPrefixes">The configuration prefixes.</param>
    /// <returns>The builder for continuation.</returns>
    public static IHostBuilder UseConfigurationExtension(this IHostBuilder builder, Action<ConfigurationBuilder> configure, params string[] configurationPrefixes)
    {
        return builder.ConfigureServices((_, services) =>
        {
            var configBuilder = services
    ...
    public static ConfigurationBuilder AddConfigurationExtension(this IServiceCollection services, params string[] configurationPrefixes)
