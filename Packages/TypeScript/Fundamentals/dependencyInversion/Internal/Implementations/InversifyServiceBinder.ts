...
class InversifyBindServiceScope extends IBindServiceScope {
    /**
     * Initializes a new instance of the {@link InversifyBindServiceScope} class.
 ...
 */
class InversifyBindServiceTo<T extends {}> extends IBindServiceTo<T> {
    /**
     * Initializes a new instance of the {@link InversifyBindServiceTo} class.
...
export class InversifyServiceBinder extends IServiceBinder {
    /**
     * Initializes a new instance of the {@link InversifyServiceBinder} class.
    ...
    /** @inheritdoc */
    bind<T extends {} = any>(service: ServiceIdentifier<T>): IBindServiceTo<T> {
